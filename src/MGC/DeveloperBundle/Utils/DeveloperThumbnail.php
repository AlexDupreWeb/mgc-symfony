...
namespace MGC\DeveloperBundle\Utils;

class DeveloperThumbnail
{
     ...
     * @param string $link
     */
    public function __construct($text, $description, $icon, $image, $link, $picture_type=self::DEFAULT_PICTURE_TYPE){
        $this->main_text = $text;
